...
The Virtual DOM/ **VISAUL DOM** is a semi-visual representation of the outcome. / preliminary representation of what the visual/graphic output will look
...
updateDom();
 ```
*Lists will give us the flexibility | scalability | and susteinable way to store and produce as many DOM elements as possible.* 